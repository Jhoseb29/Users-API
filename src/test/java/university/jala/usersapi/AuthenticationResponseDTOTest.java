...
public class AuthenticationResponseDTOTest {
    ...
    @Test
    public void testConstructorWithTokenParameter() {
    ...
    @Test
    public void testGetterForTokenAttribute() {
        String token = "jwtToken";
        AuthenticationResponseDTO responseDTO = new AuthenticationResponseDTO(token);
        assertEquals(token, responseDTO.getToken());
    }
    ...
    @Test
    public void testNullTokenAttribute() {
    ...
    @Test
    public void testEmptyTokenAttribute() {
